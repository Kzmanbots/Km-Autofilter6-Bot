...
# Bot information
SESSION = environ.get('SESSION', 'KMBot')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1003628964489')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '1003387241592').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Krazymen:S033%23%40%25%24%2A3849@krazymen.sswcjrj.mongodb.net/?appName=KRAZYMEN")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "datebasechnl")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kmcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Velox_request_group')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Velox_request_group')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Velox_request_group') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Km_zxop')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtodownload_0401/4') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
