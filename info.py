...
# ============================
SESSION = environ.get('SESSION', 'km_botz')   # Session name for the bot
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "https://t.me/+-GajZ278GmdlZjc1")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "https://t.me/+axfjnmSku5I1OTk1")# Channels for force sub (make sure bot is admin)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/howtodownload_0401/4")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/howtodownload_0401/4")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/howtodownload_0401/4")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Velox_request_group') # Group link for the bot
